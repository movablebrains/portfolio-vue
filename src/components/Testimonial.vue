            ...
            <b-row>
                <b-col lg="6" :class="`mb-5 mb-lg-7 px-lg-5`" v-for="(testimonial, index) in testimonialList" :key="index">
                    ...
                    <div class="media u-font-size-90">
                        <img class="d-flex align-self-center rounded-circle u-blockquote-v2__image u-box-shadow-lg mx-3 mt-2 lazyload" :src="`${publicPath}images/upwork.png`" :alt="`${ testimonial.name }`">
