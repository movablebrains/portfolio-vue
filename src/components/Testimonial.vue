<template>
  <section
    id="js-scroll-to-testimonials"
    class="section section-testimonial u-content-space bg-light"
  >
    <b-container>
      ...
      <b-row>
        ...
        >
          ...
          <div class="media u-font-size-90">
            <img
              class="lazyload d-flex align-self-center rounded-circle u-blockquote-v2__image u-box-shadow-lg mx-3 mt-2 lazyload"
              :data-src="`${publicPath}images/upwork.png`"
              :alt="`${ testimonial.name }`"
            />
            <div class="media-body align-self-center">
              <strong class="d-block">{{ testimonial.name }}</strong>
              <span
                class="u-font-size-75 text-dark"
